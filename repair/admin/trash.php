...
garage_tabsAdminMenu("trash.php");
...
if ($id_marque !=0){
    ...
    while ((list($id_marque,$marque) = $xoopsDB->fetchRow($res)) != false ) {$mark = $marque;}
   	...
   	echo '<tr>';
		...
		echo '<td class="'.$style.'" align="center"><A HREF="trash.php?id_inter='.$id_inter.'&op=recup" ><img src="../images/recup.png" alt="'._AM_RECUP.'" title="'._AM_RECUP.'"></a>&nbsp;<A HREF="trash.php?id_inter='.$id_inter.'&op=delete"><img src="../images/stop.png" alt="'._AM_INTER_SUPPR_DEF.'" title="'._AM_INTER_SUPPR_DEF.'"></a></td>';
}}
		echo '</tr></table><br />';
